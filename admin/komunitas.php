...
<body>
  ...
  <div class="content">
    <div class="card p-3">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#formKomunitas" id="btnTambah">
      ...
      <div class="collapse collapse-form" id="formKomunitas">
        ...
        <form id="komunitasForm">
          <input type="hidden" id="komunitasId">

          <div class="mb-3">
            <label class="form-label">Nama Komunitas</label>
            <input type="text" class="form-control" id="namaKomunitas" placeholder="Masukkan nama komunitas" required>
          </div>
          <div class="mb-3">
            <label class="form-label">Deskripsi</label>
            <textarea class="form-control" id="deskripsiKomunitas" rows="3" placeholder="Masukkan deskripsi" required></textarea>
          </div>
          <button type="submit" class="btn btn-success" id="saveBtn"><i class="bi bi-save"></i> Simpan</button>
          <button type="button" class="btn btn-secondary" data-bs-toggle="collapse" data-bs-target="#formKomunitas" id="cancelBtn">
            Batal
          </button>
        </form>
      </div>
      ...
      <table class="table mt-3 table-hover">
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td>Komunitas Gaming</td>
            <td>Tempat kumpul gamer se-Indonesia</td>
            <td>01 Okt 2025</td>
            <td>
              <button class="btn btn-sm btn-warning editBtn"><i class="bi bi-pencil-square"></i> Edit</button>
              <button class="btn btn-sm btn-danger deleteBtn" data-nama="Komunitas Gaming"><i class="bi bi-trash"></i> Hapus</button>
            </td>
          </tr>
          <tr>
            <td>2</td>
            <td>Komunitas Travel</td>
            <td>Sharing pengalaman jalan-jalan</td>
            <td>28 Sep 2025</td>
            <td>
              <button class="btn btn-sm btn-warning editBtn"><i class="bi bi-pencil-square"></i> Edit</button>
              <button class="btn btn-sm btn-danger deleteBtn" data-nama="Komunitas Travel"><i class="bi bi-trash"></i> Hapus</button>
            </td>
          </tr>
        </tbody>
      </table>
  ...
  <script>
    ...
    const komunitasForm = document.getElementById('komunitasForm');
    const namaKomunitas = document.getElementById('namaKomunitas');
    const deskripsiKomunitas = document.getElementById('deskripsiKomunitas');
    const komunitasId = document.getElementById('komunitasId');
    ...
    document.querySelectorAll('.editBtn').forEach((btn) => {
      btn.addEventListener('click', () => {
        ...
        komunitasId.value = row[0].textContent;
        namaKomunitas.value = row[1].textContent;
        deskripsiKomunitas.value = row[2].textContent;

        formTitle.textContent = "Form Edit Komunitas";
    ...
    // Klik Tambah Komunitas
    btnTambah.addEventListener('click', () => {
      formTitle.textContent = "Form Tambah Komunitas";
      saveBtn.innerHTML = '<i class="bi bi-save"></i> Simpan';
      komunitasForm.reset();
      komunitasId.value = "";
    });

    // Klik Hapus → buka modal
